...
public class VideoStoreTest {
    ...
    public void setUp() {
        ...
        chidrensMove = new ChildrensMovie("Childrens Movie");
    ...
    @Test
    public void testSingleNewReleaseStatementTotal() {
    ...
    @Test
    public void testDualNewReleaseStatementTotal() {
        statement.addRental(new Rental(newReleaseMovie1, 3));
    ...
    @Test
    public void testSingleChildrensStatementTotal() {
        statement.addRental(new Rental(chidrensMove, 3));
        statement.generate();
    ...
    @Test
    public void testMultipleRegularStatementTotal() {
